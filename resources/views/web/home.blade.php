        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="getstarted" href="{{ route('user.login') }}">Masuk</a></li>
                </ul>
            ...
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="{{ route('penduduk.login') }}" class="btn-get-started scrollto">Layanan Surat</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 piagam" data-aos="fade-left" data-aos-delay="200">
                    <img src="{{ asset('') }}web/assets/img/piagam.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
