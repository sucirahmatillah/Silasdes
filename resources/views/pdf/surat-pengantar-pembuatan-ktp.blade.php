...
@section('content')
    ...
    <p style="text-align:justify">
        Nama tersebut diatas adalah benar warga Desa {{ ucwords(kantorDesa()->kelurahan->nama ?? '-') }}, Kecamatan
        {{ ucwords(kantorDesa()->kecamatan->nama ?? '-') }}, {{ ucwords(kantorDesa()->kabKota->nama ?? '-') }}. <br>
