        ...
        <div class="container-xl">
            <div class="row g-4">
                ...
                <div class="col-lg-9 col-md-9 col-12">
                    <form id="form_submit" action="{{ route('penduduk.account.password.update') }}" method="POST">
                        @csrf
                        <div class="card">
...
@push('script')
    {!! JsValidator::formRequest('App\Http\Requests\Penduduk\Account\PasswordUpdateRequest', '#form_submit') !!}
@endpush
