                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') ?? $surat->suratKeteranganKematian->penduduk->nama }}" />
                                        @error('nama')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="bin_binti"
                                            ...
                                            value="{{ old('bin_binti') ?? $surat->suratKeteranganKematian->bin_binti }}" />
                                        @error('bin_binti')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik') ?? $surat->suratKeteranganKematian->penduduk->nik }}" />
                                        @error('nik')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        @foreach (jenisKelamin() as $item)
                                            <label class="form-check form-check-inline mt-2">
                                                <input type="radio" name="id_jenis_kelamin"
                                                    ...
                                                    value="{{ $item->id }}" @checked(old('id_jenis_kelamin') == $item->id || $surat->suratKeteranganKematian->penduduk->id_jenis_kelamin == $item->id) />
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="tempat_lahir"
                                            ...
                                            value="{{ old('tempat_lahir') ?? $surat->suratKeteranganKematian->penduduk->tempat_lahir }}" />
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="date" name="tanggal_lahir"
                                            ...
                                            value="{{ old('tanggal_lahir') ?? $surat->suratKeteranganKematian->penduduk->tanggal_lahir }}" />
                                        @error('tanggal_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <label class="form-check form-check-inline mt-2">
                                                <input type="radio" name="id_kewarganegaraan"
                                                    ...
                                                    value="{{ $item->id }}" @checked(old('id_kewarganegaraan') == $item->id ||
                                                            $surat->suratKeteranganKematian->penduduk->id_kewarganegaraan == $item->id) />
                                                <span class="form-check-label">
                                                    {{ $item->nama }}
                                                </span>
                                            </label>
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_agama" class="form-select @error('id_agama') is-invalid @enderror">
                                            ...
                                            @foreach (agama() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_agama') == $item->id || $surat->suratKeteranganKematian->penduduk->id_agama == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_status_perkawinan"
                                            ...
                                            @foreach (statusPerkawinan() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_status_perkawinan') == $item->id || $surat->suratKeteranganKematian->penduduk->id_status_perkawinan == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_pekerjaan"
                                            ...
                                            @foreach (pekerjaan() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_pekerjaan') == $item->id || $surat->suratKeteranganKematian->penduduk->id_pekerjaan == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12 mb-3">
                                                <input type="text" name="alamat"
                                                    ...
                                                    value="{{ old('alamat') ?? $surat->suratKeteranganKematian->penduduk->alamat }}" />
                                                @error('alamat')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-4 mb-3">
                                                <select class="form-select @error('rt') is-invalid @enderror"
                                                    ...
                                                    @foreach (number() as $item)
                                                        <option value="{{ $item }}" @selected(old('rt') == $item || $surat->suratKeteranganKematian->penduduk->rt == $item)>
                                                            {{ $item }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 col-4 mb-3">
                                                <select class="form-select @error('rw') is-invalid @enderror"
                                                    ...
                                                    @foreach (number() as $item)
                                                        <option value="{{ $item }}" @selected(old('rw') == $item || $surat->suratKeteranganKematian->penduduk->rw == $item)>
                                                            {{ $item }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-4 mb-3">
                                                <input type="text" name="kode_pos"
                                                    ...
                                                    value="{{ old('kode_pos') ?? $surat->suratKeteranganKematian->penduduk->kode_pos }}" />
                                                @error('kode_pos')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_provinsi"
                                                    ...
                                                    @foreach (provinsi() as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_provinsi') == $item->id || $surat->suratKeteranganKematian->penduduk->id_provinsi == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kab_kota"
                                                    ...
                                                    @foreach (kabKota(old('id_provinsi') ?? $surat->suratKeteranganKematian->penduduk->id_provinsi) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kab_kota') == $item->id || $surat->suratKeteranganKematian->penduduk->id_kab_kota == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kecamatan"
                                                    ...
                                                    @foreach (kecamatan(old('id_kab_kota') ?? $surat->suratKeteranganKematian->penduduk->id_kab_kota) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kecamatan') == $item->id || $surat->suratKeteranganKematian->penduduk->id_kecamatan == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kelurahan"
                                                    ...
                                                    @foreach (kelurahan(old('id_kecamatan') ?? $surat->suratKeteranganKematian->penduduk->id_kecamatan) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kelurahan') == $item->id || $surat->suratKeteranganKematian->penduduk->id_kelurahan == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="date" name="tanggal_meninggal"
                                            ...
                                            value="{{ old('tanggal_meninggal') ?? $surat->suratKeteranganKematian->tanggal_meninggal }}" />
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="time" name="jam_meninggal"
                                            ...
                                            value="{{ old('jam_meninggal') ?? $surat->suratKeteranganKematian->jam_meninggal }}" />
                                        @error('jam_meninggal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="tempat_meninggal"
                                            ...
                                            value="{{ old('tempat_meninggal') ?? $surat->suratKeteranganKematian->tempat_meninggal }}" />
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="sebab_kematian"
                                            ...
                                            value="{{ old('sebab_kematian') ?? $surat->suratKeteranganKematian->sebab_kematian }}" />
