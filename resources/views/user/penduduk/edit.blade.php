        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="{{ route('user.penduduk.update', $penduduk) }}" method="POST"
...
@push('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\User\Penduduk\UpdateRequest', '#form_submit') !!}
@endpush
