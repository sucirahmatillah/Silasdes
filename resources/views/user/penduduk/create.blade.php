        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="{{ route('user.penduduk.store') }}" method="POST"
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select class="form-select @error('id_golongan_darah') is-invalid @enderror"
                                            ...
                                            @foreach (golonganDarah() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_golongan_darah') == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_pendidikan"
                                            ...
                                            @foreach (pendidikan() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_pendidikan') == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_shdk"
                                            ...
                                            @foreach (shdk() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_shdk') == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
...
@push('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\User\Penduduk\StoreRequest', '#form_submit') !!}
@endpush
