                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') ?? $surat->suratKeteranganKelahiran->nama }}" />
                                        @error('nama')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        @foreach (jenisKelamin() as $item)
                                            <label class="form-check form-check-inline mt-2">
                                                <input type="radio" name="id_jenis_kelamin"
                                                    ...
                                                    value="{{ $item->id }}" @checked(old('id_jenis_kelamin') == $item->id || $surat->suratKeteranganKelahiran->id_jenis_kelamin == $item->id) />
                                    ...
                                    <div class="col-md-9 col-12">
                                        <select name="id_agama" class="form-select @error('id_agama') is-invalid @enderror">
                                            ...
                                            @foreach (agama() as $item)
                                                <option value="{{ $item->id }}" @selected(old('id_agama') == $item->id || $surat->suratKeteranganKelahiran->id_agama == $item->id)>
                                                    {{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="number" name="anak_ke"
                                            ...
                                            value="{{ old('anak_ke') ?? $surat->suratKeteranganKelahiran->anak_ke }}" />
                                        @error('anak_ke')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="date" name="tanggal_lahir"
                                            ...
                                            value="{{ old('tanggal_lahir') ?? $surat->suratKeteranganKelahiran->tanggal_lahir }}" />
                                        @error('tanggal_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="time" name="jam_lahir"
                                            ...
                                            value="{{ old('jam_lahir') ?? $surat->suratKeteranganKelahiran->jam_lahir }}" />
                                        @error('jam_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="number" name="berat_badan"
                                            ...
                                            value="{{ old('berat_badan') ?? $surat->suratKeteranganKelahiran->berat_badan }}" />
                                        @error('berat_badan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama_ayah"
                                            ...
                                            value="{{ old('nama_ayah') ?? $surat->suratKeteranganKelahiran->nama_ayah }}" />
                                        @error('nama_ayah')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="nama_ibu"
                                            ...
                                            value="{{ old('nama_ibu') ?? $surat->suratKeteranganKelahiran->nama_ibu }}" />
                                        @error('nama_ibu')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12 mb-3">
                                                <input type="text" name="alamat"
                                                    ...
                                                    value="{{ old('alamat') ?? $surat->suratKeteranganKelahiran->alamat }}" />
                                                @error('alamat')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-4 mb-3">
                                                <select class="form-select @error('rt') is-invalid @enderror"
                                                    ...
                                                    @foreach (number() as $item)
                                                        <option value="{{ $item }}" @selected(old('rt') == $item || $surat->suratKeteranganKelahiran->rt == $item)>
                                                            {{ $item }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 col-4 mb-3">
                                                <select class="form-select @error('rw') is-invalid @enderror"
                                                    ...
                                                    @foreach (number() as $item)
                                                        <option value="{{ $item }}" @selected(old('rw') == $item || $surat->suratKeteranganKelahiran->rw == $item)>
                                                            {{ $item }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-4 mb-3">
                                                <input type="text" name="kode_pos"
                                                    ...
                                                    value="{{ old('kode_pos') ?? $surat->suratKeteranganKelahiran->kode_pos }}" />
                                                @error('kode_pos')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_provinsi"
                                                    ...
                                                    @foreach (provinsi() as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_provinsi') == $item->id || $surat->suratKeteranganKelahiran->id_provinsi == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kab_kota"
                                                    ...
                                                    @foreach (kabKota(old('id_provinsi') ?? $surat->suratKeteranganKelahiran->id_provinsi) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kab_kota') == $item->id || $surat->suratKeteranganKelahiran->id_kab_kota == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kecamatan"
                                                    ...
                                                    @foreach (kecamatan(old('id_kab_kota') ?? $surat->suratKeteranganKelahiran->id_kab_kota) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kecamatan') == $item->id || $surat->suratKeteranganKelahiran->id_kecamatan == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                <select name="id_kelurahan"
                                                    ...
                                                    @foreach (kelurahan(old('id_kecamatan') ?? $surat->suratKeteranganKelahiran->id_kecamatan) as $item)
                                                        <option value="{{ $item->id }}" @selected(old('id_kelurahan') == $item->id || $surat->suratKeteranganKelahiran->id_kelurahan == $item->id)>
                                                            {{ $item->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
