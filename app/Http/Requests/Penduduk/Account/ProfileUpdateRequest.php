...
namespace App\Http\Requests\Penduduk\Account;
...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nik' => ['required', 'digits:16', 'unique:penduduk,nik,' . auth()->guard('penduduk')->id() . ',id'],
            ...
            'email' => ['required', 'email', 'max:255', 'unique:penduduk,email,' . auth()->guard('penduduk')->id() . ',id'],
