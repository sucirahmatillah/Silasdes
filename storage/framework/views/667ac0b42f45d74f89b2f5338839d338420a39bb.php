                                ...
                                <div class="form-group my-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="bin_binti"
                                            class="form-control <?php $__errorArgs = ['bin_binti'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('bin_binti')); ?>" />
                                        <?php $__errorArgs = ['bin_binti'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e($item->id); ?>" <?php if(old('id_kewarganegaraan') == $item->id): echo 'checked'; endif; ?> />
                                                <span class="form-check-label">
                                                    <?php echo e($item->nama); ?>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = statusPerkawinan(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>" <?php if(old('id_status_perkawinan') == $item->id): echo 'selected'; endif; ?>>
                                                    <?php echo e($item->nama); ?>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = pekerjaan(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>" <?php if(old('id_pekerjaan') == $item->id): echo 'selected'; endif; ?>>
                                                    <?php echo e($item->nama); ?>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="time" name="jam_meninggal"
                                            class="form-control <?php $__errorArgs = ['jam_meninggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('jam_meninggal')); ?>" />
                                        <?php $__errorArgs = ['jam_meninggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="tempat_meninggal"
                                            class="form-control <?php $__errorArgs = ['tempat_meninggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('tempat_meninggal')); ?>" />
                                        <?php $__errorArgs = ['tempat_meninggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" name="sebab_kematian"
                                            class="form-control <?php $__errorArgs = ['sebab_kematian'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('sebab_kematian')); ?>" />
...
<?php echo $__env->make('penduduk.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\desaCjb\resources\views/penduduk/surat/create/surat-keterangan-kematian.blade.php ENDPATH**/ ?>