                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Jika Anda kesulitan mengklik tombol "Verifikasi Email", salin
                                                        dan tempel URL di bawah ke browser web Anda:
                                                        <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="<?php echo e($verification_link); ?>"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;"><?php echo e($verification_link); ?></a>
                                                        </span>
                                                    </p>
...
<?php /**PATH C:\xampp\htdocs\desaCjb\resources\views/penduduk/mail/verify-email.blade.php ENDPATH**/ ?>