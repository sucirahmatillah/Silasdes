                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="file" name="file_surat_permohonan"
                                            class="form-control <?php $__errorArgs = ['file_surat_permohonan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            accept="image/png, image/jpeg" />
                                        <?php $__errorArgs = ['file_surat_permohonan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('penduduk.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\desaCjb\resources\views/penduduk/surat/create/surat-keterangan-domisili.blade.php ENDPATH**/ ?>