<?php $__env->startSection('title', 'Ubah Penduduk'); ?>
        ...
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10">
                    <form id="form_submit" action="<?php echo e(route('user.penduduk.update', $penduduk)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                                        <small class="form-hint">
                                            Digunakan untuk login penduduk (Optional)
                                        </small>
                                    </div>
                                </div>
                                <div class="form-group mb-3 row">
...
<?php $__env->startPush('script'); ?>
    ...
    <?php echo JsValidator::formRequest('App\Http\Requests\User\Penduduk\UpdateRequest', '#form_submit'); ?>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('user.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\desaCjb\resources\views/user/penduduk/edit.blade.php ENDPATH**/ ?>