        ...
        <div class="container-xl">
            <div class="row g-4">
                ...
                <div class="col-lg-9 col-md-9 col-12">
                    <form id="form_submit" action="<?php echo e(route('user.account.password.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card">
...
<?php $__env->startPush('script'); ?>
    <?php echo JsValidator::formRequest('App\Http\Requests\User\Account\PasswordUpdateRequest', '#form_submit'); ?>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('user.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\desaCjb\resources\views/user/account/password-edit.blade.php ENDPATH**/ ?>